...
public class BuscarActivity extends AppCompatActivity {
    ...
    private void insertarDatosInformacion() {
        ...
        try{
            ...
            cv.put("DIRECCION_INFORMACION", "Las Acacias 510, Temuco");
            cv.put("TELEFONO_INFORMACION","4541647898");
            cv.put("CORREO_INFORMACION","pabloneruda@pabloneruda.cl");
            cv.put("WEB_INFORMACION","www.pabloneruda.cl");
            cv.put("DIRECTOR_INFORMACION","Juanito Director");

            db.insert("INFORMACION",null,cv);
        }catch (Exception e){
    ...
    private void insertarDatosEstablecimiento() {
